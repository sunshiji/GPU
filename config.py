...
PORT_RANGE_START = int(os.getenv("GPU_MONITOR_PORT_RANGE_START", 8000))
PORT_RANGE_END = int(os.getenv("GPU_MONITOR_PORT_RANGE_END", 8100))
AUTO_PORT_SELECT = os.getenv("GPU_MONITOR_AUTO_PORT", "true").lower() in ["true", "1", "yes"]
